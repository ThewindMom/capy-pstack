...
At the end of the run, before handing back, check the log told the truth. Read this run's actual Capy thread and task messages. Restrict access to this run; preserve native IDs and explicitly label any missing history. Walk the log against what actually happened:
