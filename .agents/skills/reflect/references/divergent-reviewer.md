...
- `Read` tool calls against any `SKILL.md` file (workspace `.agents/skills/`, user-level `<selected-personal-volume>/skills/`, or plugin-installed paths under `<selected-volume>/`)
- native Capy task briefs that name a skill path
